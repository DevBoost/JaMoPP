...
public class JavaCompletionProposal implements Comparable<JavaCompletionProposal> {
	 ...
	 */
	private org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal expectedTerminal;
	...
	public JavaCompletionProposal(org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public JavaCompletionProposal(org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public JavaCompletionProposal(org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal getExpectedTerminal() {
