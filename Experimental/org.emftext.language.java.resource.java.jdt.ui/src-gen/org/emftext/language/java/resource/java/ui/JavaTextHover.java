 ...
 */
public class JavaTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private org.emftext.language.java.resource.java.IJavaHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput infoInput = (org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.java.resource.java.ui.JavaHyperlink hyperlink = new org.emftext.language.java.resource.java.ui.JavaHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl iControl = new org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput) {
							org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput input = (org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl iControl = new org.emftext.language.java.resource.java.ui.JavaBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public JavaTextHover(org.emftext.language.java.resource.java.IJavaResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.java.resource.java.ui.JavaUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.java.resource.java.ui.JavaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.java.resource.java.ui.JavaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.java.resource.java.ui.JavaHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.java.resource.java.ui.JavaTextHover.getStyleSheet());
			org.emftext.language.java.resource.java.ui.JavaHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.java.resource.java.ui.JavaDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.java.resource.java.ui.JavaHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(org.emftext.language.java.resource.java.ui.JavaUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.java.resource.java.util.JavaStreamUtil.getContent(styleSheetURL.openStream());
